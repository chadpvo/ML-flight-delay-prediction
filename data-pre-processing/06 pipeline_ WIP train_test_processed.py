...
source_path = f"{root}/fasw{time_length}/train_test"
...
# DBTITLE 1,OG DEFINE COLS
# MAGIC %skip
# MAGIC # Target Variable
# MAGIC target_col = "ARR_DEL15"
# MAGIC
# MAGIC # Numerical Cols (14 total)
# MAGIC num_cols = ["CRS_ELAPSED_TIME", "DISTANCE", "ORIGIN_LAT", "ORIGIN_LONG", "ORIGIN_ELEVATION_FT", "DEST_LAT", "DEST_LON", "DEST_ELEVATION_FT", "overall_cloud_frac_0_1", "lowest_cloud_ft", "highest_cloud_ft", "HourlyAltimeterSetting", "HourlyWindGustSpeed", "HourlyWindSpeed"]
# MAGIC num_cols_sorted = sorted(num_cols)
# MAGIC
# MAGIC # alphabetize this
# MAGIC
# MAGIC # Cols to sign logscale (if skewed)
# MAGIC cols_to_logscale = ["CRS_ELAPSED_TIME", "DISTANCE", "ORIGIN_ELEVATION_FT", "DEST_ELEVATION_FT", "lowest_cloud_ft", "highest_cloud_ft", "HourlyWindGustSpeed", "HourlyWindSpeed"]
# MAGIC
# MAGIC # Numerical (Binary) Columns (15 total)
# MAGIC binary_cols = [
# MAGIC     "IS_US_HOLIDAY",
# MAGIC     "has_few", "has_sct", "has_bkn", "has_ovc", "light", "heavy", "thunderstorm", "rain_or_drizzle",
# MAGIC     "freezing_conditions", "snow", "hail_or_ice", "reduced_visibility", "spatial_effects", "unknown_precip"
# MAGIC ]
# MAGIC # removing "CARRIER_DELAY", "NAS_DELAY", "SECURITY_DELAY", "LATE_AIRCRAFT_DELAY" for data leakage
# MAGIC
# MAGIC # Categorical Columns (15 total)
# MAGIC cat_cols = ["OP_UNIQUE_CARRIER","ORIGIN","ORIGIN_STATE_ABR","DEST","DEST_STATE_ABR","ORIGIN_SIZE","DEST_SIZE","HourlyWindCardinalDirection"]
# MAGIC cyclical_cols = ["QUARTER", "MONTH", "DAY_OF_MONTH", "DAY_OF_WEEK", "CRS_DEP_TIME_BLOCK", "CRS_ARR_TIME_BLOCK"]
# MAGIC # removing "YEAR"
# MAGIC # not including high_cat_cols = ["TAIL_NUM"]
# MAGIC
# MAGIC #feature_cols = num_cols + binary_cols + cat_cols #+ high_cat_cols -- causing issues because of high cardinality
...
# DBTITLE 1,TRANSFORM FINAL TRAIN + UNSEEN TEST
# Directory / paths
input_path = source_path
output_path = f"{root}/fasw{time_length}/processed_train_test"
...
val_path = f"{input_path}/split=test"
...
# MAGIC %skip
# MAGIC train_path = f"{output_path}/train"
# MAGIC df = spark.read.parquet(train_path)
# MAGIC display(df)
...
# MAGIC
# MAGIC ## 3m:
# MAGIC Windows saved as parquet to: dbfs:/student-groups/Group_02_01/fasw_3m/processed_train_test/train. Row count: 850586
# MAGIC <br>
# MAGIC Windows saved as parquet to: dbfs:/student-groups/Group_02_01/fasw_3m/processed_train_test/test. Row count: 485186
# MAGIC
# MAGIC ## 6m:
# MAGIC Windows saved as parquet to: dbfs:/student-groups/Group_02_01/fasw_6m/processed_train_test/train. Row count: 2292318
# MAGIC <br>
# MAGIC Windows saved as parquet to: dbfs:/student-groups/Group_02_01/fasw_6m/processed_train_test/test. Row count: 486537
# MAGIC
# MAGIC ## 1y:
# MAGIC Windows saved as parquet to: dbfs:/student-groups/Group_02_01/fasw_1y/processed_train_test/train. Row count: 5366265
# MAGIC <br>
# MAGIC Windows saved as parquet to: dbfs:/student-groups/Group_02_01/fasw_1y/processed_train_test/test. Row count: 1902524
# MAGIC
# MAGIC
# MAGIC ## 5y:
# MAGIC
# MAGIC Windows saved as parquet to: dbfs:/student-groups/Group_02_01/fasw/processed_train_test/train. Row count: 23873225
# MAGIC <br>
# MAGIC Windows saved as parquet to: dbfs:/student-groups/Group_02_01/fasw/processed_train_test/test. Row count: 7271711
